...
let githubLink = "http://github.com/cloudroutine/FsBuild"

// Specify more information about your project
let info =
  [ "project-name", "FsBuild"
    "project-author", "Jared Hester"
    "project-summary", "EDSL for .fsproj files and MSBuild Tasks"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/FsBuild" ]
